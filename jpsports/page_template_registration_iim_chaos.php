<?php
/**
 Template Name: Registration iim chaos page
 */
...
<script type="text/javascript">
    ...
    function validation()
    {
		...
		<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( '231' ), 'single-post-thumbnail' );  
				?>
			...
			if($s_status != 'success') { ?>
			<div id="slider">
			<div class="header-img" style="background-color:#62b661;">
