<?php
/**
 Template Name:Obstacle Events workshops
 */
...
function get_action(form) 
{
  ...
  function checkregistrationemail()
	...
	<?php $image = wp_get_attachment_image_src( get_post_thumbnail_id( '755' ), 'single-post-thumbnail' );  ?>
	<?php	
	//echo dirname( __FILE__ ) . '/payu.php';exit;
	...
	function payment_success() {
				...
				$timeslot = '';
				if($query_run2[0]->category == '6to7:30')
				{
					$timeslot = '6:00 To 7:30 PM';
				} else {
				...
				$subject = 'PAYMENT SUCCESSFUL - REGISTRATION CONFIRMED';
					...
					$body = '
                        <b>Congratulations! Your registration for Battle Rope Workshop has been confirmed. Here are the details of your transaction for your reference:</b><br /><br />
                       ...
                       // $headers .= 'Cc:contact@jpsport.in' . "\r\n";
                        $headers .= 'Cc:hiri@elegantmicroweb.com' . "\r\n";
						...
						//echo "";
						header("location:http://extremefitnessindia.in/thank-you/");
						exit;
	...
	if ( (isset($_POST['btn_submit'])  || isset($_POST['btn_submit1'])) && trim($_POST['fullname']) !='' && trim($_POST['gen']) !='' && trim($_POST['bld']) !='' && trim($_POST['dob']) !='' && trim($_POST['contact_no']) !='' && trim($_POST['email']) !='' && trim($_POST['select-cat']) !='' ) 
			{
				...
				global  $wpdb;
						...
						$querys1="Select id from user WHERE race_category='755' order by id desc limit 0,1";				
						...
						$bip_no = '';
						$bip_no1 = '';
						$querys1 = "Select gender,category,bip_no,race_category from user WHERE race_category='755' order by id desc limit 0,1";
					...
					$insert_val .= "userid=".$userid."<br/>";
						...
						$headers  = 'MIME-Version: 1.0' . "\r\n";
                        $headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
                        $headers .= 'From:hiri@elegantmicroweb.com'." <Priyank>\r\n";

                        mail('hiri@elegantmicroweb.com','insert query',$insert_val,$headers);
					/*end mail*/
//					echo "INSERT INTO user (amount, full_name, contact_no,email,occupation,date_of_birth,blood_type,gender,race_category,category,age_group,t_shirt_size,address,city,state,country,zipcode,contact_person_name,contact_person_name2,contact_person_contact_no,contact_person_contact_no2,participant_no,nationality,bikemake,previous_cycling_experiences,other_adventure_sports,geared,bip_no,userid,cyclothon_type,cyclothon_year,create_date) VALUES ('".$amount."','".$fullname."','".$contactno."','".$email."','".$occupation."','".$dofb."','".$bloodtype."','".$gender."','".$racecategory."','".$category."','".$age_group."','".$t_shirt_size."','".$addressline."','".$city."','".$state."','".$country."','".$zip_code."','".$contactperson."','".$contactperson2."','".$contact_no."','".$contact_no2."','".$participant_no."','".$nationality."','".$bikemake."','".$previous_cycling_experiences."','".$other_adventure_sports."','".$geared."','".$bip_no."','".$userid."','".$cyclothon_type."','".$cyclothon_year."',now())";
					...
					if($wpdb->insert( $table_name, array(
						...
						$query_run = $wpdb->query($querys);
							...
							if($wpdb->num_rows > 0) {
							//	echo "already exits";exit;
							header("location:http://extremefitnessindia.in/events-workshops/");
								...
								pay_page( array (
									...
									'key' => 'gtKFFx', // test : gtKFFx    ||    live : YpOaMs
									'txnid' => $_POST['txnid'],
									//'amount'=> $_POST['amt'],
									'amount'=> $amount,
									'udf1'=> $userid,
							...
							'eCwWELxi'); // test : eCwWELxi    ||    live : f0SXJsMM
								exit;
							}
						...
						<div class="certificate_sec">
							...
							<div class="right_fields">
								<div class="right_label">
								 ...
								 <div class="right_text">
								  <input type="text" name="age" id="age" pattern="^\d+$" title="Only number allowed"  />
								  </div>
							</div>
							<div class="clear"></div>
								...
								<div class="right_label">
								 ...
								 <div class="right_text">
									  <select name="select-cat" id="select-cat">
										  <option value="">Select</option>
										   <option value="6to7:30">6:00 To 7:30 PM</option>
										  <option value="6to7">6:00 To 7:0 AM</option>
							...
							<input name="amt" id="amt" type="hidden" value="700">
